...
<div class="box">
	...
	<form method="post" class="form-x" action="actions.php" enctype="multipart/form-data">  
		...
		<table class="profile-table">
			<tr><th>名称：</th><td><input type="text" name="word" required class="long input" /></td></tr>
			<tr><th>图片：</th><td><input type="file" name="pic" required ></td></tr>
			<tr><th>画质：</th><td><input type="text" name="fbl" class="input" required /></td></tr>
            <tr><th>下载量：</th><td><input type="text" name="dwl" class="input" required /></td></tr>
			<tr><th>主题：</th><td><input type="text" name="zt" class="input" required /></td></tr>
